...
const responsivePersonAboveCartWithLabelValues = (canvas) => [
  {
    screenWidth: 320,
    x: canvas.width - 45,
    y: canvas.width / 4.1,
...
export function getResponsivePersonAboveCartDimensions(canvas, screenWidth) {
  ...
  for (const rule of responsivePersonAboveCartWithLabelValues(canvas)) {
