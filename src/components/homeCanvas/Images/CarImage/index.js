...
const responsiveCarImageWithLabelValues = (canvas) => [
  ...
  },
  {
    ...
    width: canvas.width / 2 - 259,
    height: canvas.width / 2 - 316,
    rotation: 0,
    updatedX: canvas.width / 2,
    updatedY: canvas.height / 2,
    updatedWidth: 0,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 375,
    y: canvas.height / 2 - 210,
    width: canvas.width / 2 - 523,
    height: canvas.width / 2 - 618,
    rotation: 0,
    updatedX: canvas.width / 2,
    updatedY: canvas.height / 2,
    updatedWidth: 0,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 375,
    y: canvas.height / 2 - 210,
    width: canvas.width / 2 - 619,
    height: canvas.width / 2 - 714,
    rotation: 0,
    updatedX: canvas.width / 2,
    updatedY: canvas.height / 2,
    updatedWidth: 0,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 375,
    y: canvas.height / 2 - 210,
    width: canvas.width / 2 - 715,
    height: canvas.width / 2 - 810,
    rotation: 0,
    updatedX: canvas.width / 2,
    updatedY: canvas.height / 2,
    updatedWidth: 0,
  ...
  },
  {
    ...
    width: canvas.width / 2 - 880,
    height: canvas.width / 2 - 980,
    rotation: 0,
    updatedX: canvas.width / 2,
    updatedY: canvas.height / 2,
    updatedWidth: 0,
