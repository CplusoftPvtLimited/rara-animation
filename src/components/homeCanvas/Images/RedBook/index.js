...
const responsiveRedBookWithLabelValues = (canvas) => [
  ...
  },
  {
    ...
    width: canvas.width / 2 - 329,
    height: canvas.width / 2 - 339,
    rotation: 0,
  ...
  },
  {
    ...
    width: canvas.width / 2 - 442,
    height: canvas.width / 2 - 452,
    rotation: 0,
    updatedX: canvas.width / 2 + 140,
    updatedY: canvas.height / 2 - 130,
    updatedWidth: 45,
  ...
  },
  {
    ...
    y: canvas.height / 2 - 220,
    width: canvas.width / 2 - 620,
    height: canvas.width / 2 - 625,
    rotation: 0,
    updatedX: canvas.width / 2 + 140,
    updatedY: canvas.height / 2 - 130,
    updatedWidth: 45,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 220,
    y: canvas.height / 2 - 220,
    width: canvas.width / 2 - 668,
    height: canvas.width / 2 - 673,
    rotation: 0,
    updatedX: canvas.width / 2 + 140,
    updatedY: canvas.height / 2 - 130,
    updatedWidth: 45,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 220,
    y: canvas.height / 2 - 220,
    width: canvas.width / 2 - 764,
    height: canvas.width / 2 - 769,
    rotation: 0,
    updatedX: canvas.width / 2 + 140,
    updatedY: canvas.height / 2 - 130,
    updatedWidth: 45,
...

  {
    ...
    x: canvas.width / 2 + 220,
    y: canvas.height / 2 - 220,
    width: canvas.width / 2 - 860,
    height: canvas.width / 2 - 865,
    rotation: 0,
    updatedX: canvas.width / 2 + 140,
    updatedY: canvas.height / 2 - 130,
    updatedWidth: 45,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 220,
    y: canvas.height / 2 - 220,
    width: canvas.width / 2 - 1180,
    height: canvas.width / 2 - 1185,
    rotation: 0,
    updatedX: canvas.width / 2 + 140,
    updatedY: canvas.height / 2 - 130,
    updatedWidth: 45,
