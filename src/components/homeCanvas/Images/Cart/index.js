...
const responsiveCartWithLabelValues = (canvas) => [
  ...
  },
  {
    ...
    x: canvas.width - 185,
    y: canvas.height / 2 - 20,
    width: canvas.width / 2 - 730,
    height: canvas.width / 2 - 705,
    rotation: 0,
    updatedX: canvas.width / 2 + 285,
    updatedY: canvas.height / 2 - 30,
    updatedWidth: 75,
