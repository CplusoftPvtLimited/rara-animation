...
const responsiveSkullWithLabelValues = (canvas) => [
  ...
  },
  {
    ...
    x: canvas.width / 2 + 80,
    y: -20,
    width: canvas.width / 2 - 595,
    height: canvas.width / 2 - 585,
    rotation: 0,
    updatedX: canvas.width / 2 + 235,
    updatedY: canvas.height / 2 - 145,
    updatedWidth: 80,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 80,
    y: -20,
    width: canvas.width / 2 - 643,
    height: canvas.width / 2 - 633,
    rotation: 0,
    updatedX: canvas.width / 2 + 235,
    updatedY: canvas.height / 2 - 145,
    updatedWidth: 80,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 80,
    y: -20,
    width: canvas.width / 2 - 739,
    height: canvas.width / 2 - 729,
    rotation: 0,
    updatedX: canvas.width / 2 + 235,
    updatedY: canvas.height / 2 - 145,
    updatedWidth: 80,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 80,
    y: -20,
    width: canvas.width / 2 - 835,
    height: canvas.width / 2 - 825,
    rotation: 0,
    updatedX: canvas.width / 2 + 235,
    updatedY: canvas.height / 2 - 145,
    updatedWidth: 80,
