...
const responsiveEyeWithLabelValues = (canvas) => [
  ...
  },
  {
    ...
    width: canvas.width / 2 - 249,
    height: canvas.width / 2 - 284,
    rotation: 0,
  ...
  },
  {
    ...
    width: canvas.width / 2 - 332,
    height: canvas.width / 2 - 392,
    rotation: 0,
    updatedX: canvas.width / 2 + 105,
    updatedY: canvas.height / 2 + 100,
    updatedWidth: 80,
  ...
  },
  {
    ...
    y: canvas.height / 2 + 150,
    width: canvas.width / 2 - 445,
    height: canvas.width / 2 - 505,
    rotation: 0,
    updatedX: canvas.width / 2 + 105,
    updatedY: canvas.height / 2 + 100,
    updatedWidth: 80,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 355,
    y: canvas.height / 2 + 150,
    width: canvas.width / 2 - 493,
    height: canvas.width / 2 - 553,
    rotation: 0,
    updatedX: canvas.width / 2 + 105,
    updatedY: canvas.height / 2 + 100,
    updatedWidth: 80,
  ...
  },
  {
    ...
    x: canvas.width / 2 + 355,
    y: canvas.height / 2 + 150,
    width: canvas.width / 2 - 589,
    height: canvas.width / 2 - 649,
    rotation: 0,
    updatedX: canvas.width / 2 + 105,
    updatedY: canvas.height / 2 + 100,
    updatedWidth: 80,
...

  {
    ...
    x: canvas.width / 2 + 355,
    y: canvas.height / 2 + 150,
    width: canvas.width / 2 - 685,
    height: canvas.width / 2 - 745,
    rotation: 0,
    updatedX: canvas.width / 2 + 105,
    updatedY: canvas.height / 2 + 100,
    updatedWidth: 80,
  ...
  {
    screenWidth: 2560,
    x: canvas.width / 2 + 555,
    y: canvas.height / 2 + 200,
    width: canvas.width / 2 - 875,
    height: canvas.width / 2 - 260,
    rotation: 0,
    updatedX: canvas.width / 2 + 105,
    updatedY: canvas.height / 2 + 100,
    updatedWidth: 80,
