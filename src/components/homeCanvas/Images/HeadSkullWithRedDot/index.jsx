...
const responsiveHeadSkullWithRedDotValues = (canvas) => [
  ...
  },
  {
    ...
    y: canvas.width / 2 - 460,
    width: canvas.width / 2 - 560,
    height: canvas.width / 2 - 560,
    rotation: 0,
    updatedX: canvas.width / 2 - 260,
    updatedY: canvas.width / 2 - 357,
    updatedWidth: 60,
  ...
  },
  {
    ...
    width: canvas.width / 2 - 670,
    height: canvas.width / 2 - 670,
    rotation: 0,
    updatedX: canvas.width / 2 - 260,
    updatedY: canvas.width / 2 - 357,
    updatedWidth: 60,
  ...
  },
  {
    ...
    width: canvas.width / 2 - 780,
    height: canvas.width / 2 - 780,
    rotation: 0,
    updatedX: canvas.width / 2 - 260,
    updatedY: canvas.width / 2 - 357,
    updatedWidth: 60,
  ...
  },
  {
    screenWidth: 1920,
    x: 490,
    y: canvas.width / 2 - 740,
    width: canvas.width / 2 - 880,
    height: canvas.width / 2 - 880,
    rotation: 0,
    updatedX: canvas.width / 2 - 260,
    updatedY: canvas.width / 2 - 357,
    updatedWidth: 60,
